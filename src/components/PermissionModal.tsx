    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
      ...
      >
        ...
        <p className="text-white/60 text-sm mb-6 leading-relaxed">
          {isAndroidApp
            ? "Android blocked microphone access for Arclight. Zoya cannot hear you until microphone permission is allowed."
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-left w-full mb-8">
          ...
          {isAndroidApp ? (
            <ol className="text-xs text-white/60 list-decimal pl-4 space-y-2">
              <li>
                Open Android <strong>Settings</strong>.
              </li>
              <li>
                Go to <strong>Apps</strong> &gt; <strong>Arclight</strong> &gt; <strong>Permissions</strong>.
              </li>
              <li>
                Set <strong>Microphone</strong> to <strong>Allow</strong>, then reopen the app.
              </li>
            </ol>
          ) : (
            <ol className="text-xs text-white/60 list-decimal pl-4 space-y-2">
              <li>
                Click the <strong>lock icon</strong> or <strong>tune icon</strong> next to the URL bar at the top of your browser.
              </li>
              <li>
        ...
        <div className="flex flex-col w-full gap-3">
          ...
          >
            {isAndroidApp ? "I've allowed it, Restart Voice" : "I've allowed it, Refresh Page"}
          </button>
          <button
            onClick={onClose}
